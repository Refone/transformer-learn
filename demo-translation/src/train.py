...
def train_chinese_to_english():
    ...
    train_dataloader = TranslateDataLoader(is_train=True)
    ...
    for epochs in range(EPOCHS):
        ...
        # 训练一个轮次, 返回平均损失
        train_loss = train_one_epoch(model=model, train_loader=train_dataloader,
...
def train_one_epoch(model, train_loader,
    ...
    for inputs, targets in tqdm(train_loader, desc='训练'):
        ...
        # 0. 准备工作
        # 截取 decoder_inputs 和 decoder_outputs
